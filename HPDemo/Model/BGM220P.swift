...
struct BGM220PGatt {
    weak var throughputService: CBService?
    weak var indicationsCharacteristic: CBCharacteristic?
    weak var notificationsCharacteristic: CBCharacteristic?
}

open class BGM220P: NSObject {
